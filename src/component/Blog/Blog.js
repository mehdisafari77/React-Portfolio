...
class Blog extends Component{
    render(){
        return(
            <section className="blog_area bg_color" id="blog">
                <div className="container">
                    ...
                    <Reveal effect="fadeInUp" duration={1000}>
                        <div className="row container2">
                            <BlogItems bTitle1="Creation of jQuery" bDetails="jQuery is a JavaScript library that was created in order to simplify the DOM tree traversing of HTML...." btnText1="Read More" image="jq.jpeg" Pdata="Nov 07"/>
